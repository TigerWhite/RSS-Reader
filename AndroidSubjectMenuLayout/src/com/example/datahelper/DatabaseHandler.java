...
//		}
	...
	public void initDefaultMetroItem(){
		addData(new MetroItem(context, R.drawable.selector_orange, 1));
		addData(new MetroItem(context, R.drawable.selector_blue1, 2));
		addData(new MetroItem(context, R.drawable.selector_green2, 3));
		addData(new MetroItem(context, R.drawable.selector_yellow, 4));
		addData(new MetroItem(context, R.drawable.selector_green1, 5));
		addData(new MetroItem(context, R.drawable.selector_blue3, 6));
		addData(new MetroItem(context, R.drawable.selector_pink, 7));
		addData(new MetroItem(context, R.drawable.selector_green3, 8));
		addData(new MetroItem(context, R.drawable.selector_yellow, 9));
		addData(new MetroItem(context, R.drawable.selector_blue4, 10));
