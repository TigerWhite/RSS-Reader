...
public class MetroActivity extends Activity implements OnClickListener, OnLongClickListener {
...
//		Log.d("tag", "sizeMetro2: "+ mMetroItem.size());
		mMetroItem.add(new MetroItem(this, "Add", R.drawable.selector_add, "http://www.thanhnsfsdien.comnnn.vn/_layouts/newsrss.aspx?Channel=Gi%C3%A1o+d%E1%BB%A5c",mMetroItem.size()+1));
		generateView();
	...
	public  void addSocialMetroItem(int[] params){
		for(int i = 1; i <= params.length; i ++){
			if(params[i] == 1)
				switch(i){
				case 0:
					db.addData(new MetroItem(this, "Facebook", R.drawable.selector_orange, "facebook", 11));
					break;
				case 1:
					db.addData(new MetroItem(this, "Twiter", R.drawable.selector_orange, "twiter", 11));
					break;
				case 2:
					db.addData(new MetroItem(this, "Google+", R.drawable.selector_orange, "google+", 11));
					break;
				}
