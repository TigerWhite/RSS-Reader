...
//	            1f, Animation.RELATIVE_TO_SELF, 0f);
	    slide = new ScaleAnimation((float)1,
...
//		final int imageArray[] = {R.drawable.pink,R.drawable.pink_pressed};
		if(isGetTwoUrlFromRSSUrl("http://dantri.com.vn/") != 0){
//			if(id <= 10){
	         ...
	         Runnable runnable = new Runnable() {
	            int i=0;
			            public void run() {
			            	...
			            	if(i == 0){
			            		Picasso.with(getContext()).load(urlList.get(0)).into(imageView1);
			            		Picasso.with(getContext()).load(urlList.get(1)).into(imageView2);
//			                imageView.setImageResource(imageArray[i]);
//			                imageView2.setImageResource(imageArray[i+1]);
//			        	    imageView2.startAnimation(slide);
			            	}
			            	if(i == 1){
			            		Picasso.with(getContext()).load(urlList.get(1)).into(imageView1);
			            		Picasso.with(getContext()).load(urlList.get(0)).into(imageView2);
//				                imageView.setImageResource(imageArray[i]);
//				                imageView2.setImageResource(imageArray[i-1]);
				            	}
			            	 imageView2.startAnimation(slide);
	...
	public int isGetTwoUrlFromRSSUrl(String url){
		...
		if(url.equals("facebook") == true || url.equals("twiter") == true || url.equals("google+") == true ){
			return 0;
		}
		...
		if (inStream == null){
			...
			if(temp.size() == 0 || temp == null ||temp.get(0) == null || temp.get(0).getThumbnail() == null){ 
