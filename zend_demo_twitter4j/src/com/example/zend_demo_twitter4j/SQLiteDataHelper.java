...
public class SQLiteDataHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "CREATE TABLE home ("
			+ HOME_COL + " INTEGER NOT NULL PRIMARY KEY, " + UPDATE_COL
			+ " TEXT, " + USER_COL + " TEXT, " + TIME_COL + " INTEGER, "
			+ USER_IMG + " TEXT);";
	...
	/**
	 * getValues retrieves the database records - called from TimelineUpdater in
	 * TimelineService - this is a static method that can be called without an
